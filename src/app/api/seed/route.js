...
const TOURNAMENT_DATA = [
  { matchNumber: 1, stage: 'group', group: 'A', player1: 'Sadique', player2: 'Nehal', timeSlot: '0:00 – 0:10' },
  { matchNumber: 2, stage: 'group', group: 'A', player1: 'Nehal', player2: 'Mynul', timeSlot: '0:10 – 0:20' },
  { matchNumber: 3, stage: 'group', group: 'A', player1: 'Sadique', player2: 'Mynul', timeSlot: '0:20 – 0:30' },
  { matchNumber: 4, stage: 'group', group: 'B', player1: 'Arif', player2: 'Shahriar', timeSlot: '0:30 – 0:40' },
  { matchNumber: 5, stage: 'group', group: 'B', player1: 'Shahriar', player2: 'Rifat', timeSlot: '0:40 – 0:50' },
  { matchNumber: 6, stage: 'group', group: 'B', player1: 'Arif', player2: 'Rifat', timeSlot: '0:50 – 1:00' },
